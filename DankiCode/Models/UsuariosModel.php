<?php 
    ...
    class UsuariosModel{
        ...
        public static function listarAmizadesPendentes(){
            ...
            $listtarAmizadesPendentes = $pdo->prepare("SELECT * FROM amizades WHERE recebeu = ? AND status = 0 ");
            $listtarAmizadesPendentes->execute(array($_SESSION['id']));

            return $listtarAmizadesPendentes->fetchAll();
